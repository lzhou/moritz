...
*/
#ifndef TIPA_RESULT_TERMINATE_H
 #define TIPA_RESULT_TERMINATE_H
...
/*!
 @brief store the result of a tiny parser object
*/
class TiPa_Result_Terminate: public TiPa_Result
{
 public:
...
*/
 TiPa_Result_Terminate(TiPa_Abstract*        owner,
...
*/
TiPa_Result_Terminate(const TiPa_Result_Terminate& original);
...
*/
TiPa_Result_Terminate& operator=(const TiPa_Result_Terminate& original);
...
/*!
  @brief cast to @ref TiPa_Result_Terminate
*/
